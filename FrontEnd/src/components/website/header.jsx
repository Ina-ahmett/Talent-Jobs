  ...
  return (
    <div className="bg-white flex justify-between items-center px-6 py-4 md:px-10 ">
      ...
      <ul className="hidden md:flex gap-6 text-lg">
        ...
        <NavLink to="/yourJobs" className= {({ isActive }) => isActive? "border-b-2 border-blue-500 text-blue-500 font-semibold": "hover:text-gray-600 hover:border-b-2 hover:border-blue-400"}> 
          <li className="cursor-pointer px-3 py-1 transition-all duration-300">Your Jobs</li> 
        </NavLink> 
